...
# Reutilizamos las funciones y variables del script anterior
...
def create_occlusion_map(
    ...
    for y in range(0, H - patch_size, stride):
        for x in range(0, W - patch_size, stride):
            ...
            # Ocultamos el parche poniéndolo a 0
    ...
    # Normalización del mapa de sensibilidad
...
def visualize_occlusion(
    ...
    plt.tight_layout()
    plt.savefig("reports/gradcam_examples/occlusion.png")
    plt.show()
